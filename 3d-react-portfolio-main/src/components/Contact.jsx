  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Ankith gowrishanakr esturi R",
          from_email: form.email,
          to_email: "esturiankith@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:esturiankith@gmail.com" target="_blank" className="blue-text-gradient">esturiankith@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
