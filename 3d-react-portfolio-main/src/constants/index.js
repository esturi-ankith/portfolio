import {
  ...
  const profiles = [
    {
      link: "https://auth.geeksforgeeks.org/user/ankithesturi",
    ...
    {
      link:"https://developers.google.com/profile/u/104999609418661838583",
      icon: holopin,
    },
  ];
  ...
  const achievements = [
    ...
    {
      title: "Branch Head of computer science engineering  Department (2021 - 2022)",
    },
    {
      title: "Selected in top 100 candidates for Google Cloud Training among 20k Students.",
    },
    {
      title: "Got Education Scholarship Scheme for teacher benifit fund (2015 - 2023)",
    },
    {
  ...
  const experiences = [
    {
      ...
      company_name: " ritaatronics innovations.",
      icon: bny,
      iconBg: "#383E56",
    ...
    },
    {
      ...
      company_name: "ISRO telemetry and command network -14",
      ...
      link: "",
      points: [
        "I was in rescue and meosar dept. in ISRO telemetry and command network for 3 months .",
        "",
        "",
      ],
    ...
    {
      title: "Microsoft certification on javascript",
      company_name: "microsoft asure certification",
      icon: "https://images.app.goo.gl/nmZCxs1AZCgt1Pp59",
      iconBg: "#E6DEDD",
      date: "Jan 2021 - Apr 2021",
      link: "",
      points: [
        "Introduction to javascript and more functionalities with free access to quests, skill badges.",
        "Collaborating with cross-functional technologies.",
        "Got introduced to  Application Development, Big Data and Machine Learning using microsoft asure on training platform vs code",
        "Additional self-paced labs were provided to practice on Qwiklabs a platform by Google",
      ],
      link: "https://www.certiport.com/portal/Pages/PrintTranscriptInfo.aspx?pke=1&action=Result&id=+SOo6eL7UlrRwFJpYR894w==",
    },
    {
      ...
      link: "",
      points: [
        "this is a government based certification for cloud computing and distributed system which is one of the Gain a thorough understanding of cloud computing principles and their underlying distributed systems mechanisms Develop problem-solving skills for designing and managing scalable and resilient cloud systems Prepare for careers in cloud computing",
         "distributed systems", 
        " related fields Enhance your knowledge of key distributed algorithms and data structures Stay updated on the latest advancements in cloud technologies and distributed systems research ",
      ],
      link: "https://dev.to/gowrishankar123cmyke",
    },
  ];
  ...
  const educations = [
    {
      ...
      marks:
        "CGPA : 6.8 / 10",
      name: "sri jagathguru chandrashakaranatha institute of technology,chikkabullapur",
      year: "(2020 - 2024)",
      image: clg,
    },
    {
    ...
    },
    {
      ...
      marks:
        "Percentage : 78.8 %",
      name: "vidhyanidhi public school gauribidnur",
      year: "2018",
      image: school,
    },
  ];
